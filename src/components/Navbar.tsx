          ...
          >
            <div className="px-4 pt-2 pb-4 space-y-1">
              ...
              <a
                href="/my-resume.pdf"
                download
                className="flex items-center w-full px-4 py-3 rounded-md text-base font-medium text-muted-foreground hover:bg-accent hover:text-accent-foreground"
              >
                <Download className="h-5 w-5 mr-2" />
                {t({ en: 'Download Resume', fr: 'Télécharger CV' })}
              </a>
